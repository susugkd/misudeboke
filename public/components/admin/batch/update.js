	...
	template: `
		<el-dialog title="修改" width="600px" class="icon-dialog" :visible.sync="show" @open="open" :before-close="closeForm" append-to-body>
			<el-form :size="size" ref="form" :model="form" :rules="rules" :label-width=" ismobile()?'90px':'16%'">
				...
				<el-row >
					<el-col :span="24">
						<el-form-item label="操作明细" prop="wb">
							<el-input  type="textarea" autoComplete="off" v-model="form.wb"  :autosize="{ minRows: 2, maxRows: 4}" clearable placeholder="操作明细"/>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row >
					<el-col :span="24">
						<el-form-item label="参考链接" prop="amount">
							<el-input  v-model="form.amount" autoComplete="off" clearable  placeholder="请输参考链接"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
			<el-row >
